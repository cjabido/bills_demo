...
export default function MarkPaidModal({ bill, onConfirm, onClose }: MarkPaidModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      ">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-border-dim">
          <h2 className="text-base font-semibold text-text-primary">Mark as Paid</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <p className="text-sm text-text-secondary">
            Confirm payment for <span className="font-medium text-text-primary">{bill.name}</span>
          </p>
